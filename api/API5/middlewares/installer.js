...
module.exports = (req, res, next) => {
    try {
        axios
            .post('http://localhost:3000/api/api5/books', book1)
            .then(res => {
            ...
            axios
            .post('http://localhost:3000/api/api5/books', book2)
            .then(res => {
            ...
            axios
            .post('http://localhost:3000/api/api5/books', book3)
            .then(res => {
            ...
            axios
            .post('http://localhost:3000/api/api5/books', book4)
            .then(res => {
            ...
            axios
            .post('http://localhost:3000/api/api5/books', book5)
            .then(res => {
